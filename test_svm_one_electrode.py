...
if __name__ == '__main__':
    ...
    test_scenarios = [
        ...
        {'data_type': 'epoched', 'db': 4, 'kernel': 'linear', 'electrode' : elec, 'generalized': False},
        {'data_type': 'epoched', 'db': 4, 'kernel': 'rbf', 'electrode' : elec, 'generalized': True},
        {'data_type': 'epoched', 'db': 4, 'kernel': 'rbf', 'electrode' : elec, 'generalized': False},

        {'data_type': 'epoched', 'db': 6, 'kernel': 'linear', 'electrode' : elec, 'generalized': True},
        {'data_type': 'epoched', 'db': 6, 'kernel': 'linear', 'electrode' : elec, 'generalized': False},
        {'data_type': 'epoched', 'db': 6, 'kernel': 'rbf', 'electrode' : elec, 'generalized': True},
        {'data_type': 'epoched', 'db': 6, 'kernel': 'rbf', 'electrode' : elec, 'generalized': False},

        {'data_type': 'whole', 'db': 4, 'kernel': 'linear', 'electrode' : elec, 'generalized': True},
        {'data_type': 'whole', 'db': 4, 'kernel': 'linear', 'electrode' : elec, 'generalized': False},
        {'data_type': 'whole', 'db': 4, 'kernel': 'rbf', 'electrode' : elec, 'generalized': True},
        {'data_type': 'whole', 'db': 4, 'kernel': 'rbf', 'electrode' : elec, 'generalized': False},

        {'data_type': 'whole', 'db': 6, 'kernel': 'linear', 'electrode' : elec, 'generalized': True},
        {'data_type': 'whole', 'db': 6, 'kernel': 'linear', 'electrode' : elec, 'generalized': False},
        {'data_type': 'whole', 'db': 6, 'kernel': 'rbf', 'electrode' : elec, 'generalized': True},
        {'data_type': 'whole', 'db': 6, 'kernel': 'rbf', 'electrode' : elec, 'generalized': False},
